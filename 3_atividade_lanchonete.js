...
let Pao = prompt("Digite o preço : R$ ")
let salsicha = prompt("Digite o preço : R$ ")
let bacon = prompt("Digite o preço : R$ ")
let pure_batata = prompt("Digite o preço : R$ ")
let salada = prompt("Digite o preço : R$ ")
let batata_palha = prompt("Digite o preço : R$ ")

let hotdog 

/*

Você foi contrado para criar o sistema de uma lanchonete.
